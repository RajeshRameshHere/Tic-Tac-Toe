...
let box_array=[box1,box2,box3,box4,box5,box6,box7,box8,box9];
  ...
  return (
      ...
      <h1 className='title' ref={title}>Tic-Tac-Toe  </h1>
...
<div className='entry1'> <h1 className='p_title' >Player-1   </h1></div> </div>
<div className='player2'> 
<div className='entry2'><h1 className='p_title' >Player-2  </h1> </div>
